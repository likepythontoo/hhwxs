    ...
    <div className="top-bar">
      <div className="container mx-auto flex items-center justify-between px-4 py-2 text-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="font-serif text-base tracking-widest font-semibold text-white"><span className="font-serif text-base tracking-widest font-semibold text-white">红 湖 文 学 社</span>
        </div>
