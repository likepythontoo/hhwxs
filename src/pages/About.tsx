...
const timelinePhases = [
  ...
  },
  {
    ...
    events: [
      ...
      { year: "2023", event: "举行二十周年社庆，获河北省高校「优秀校园文学社团」；社刊年度精选辑获省高校优秀校刊评选二等奖" },
...
const awards = [
  ...
  { year: "2023", title: "河北省高校"优秀校园文学社团"", org: "河北省高校文学社联盟", level: "省级" },
  { year: "2023", title: "社刊年度精选辑获省高校优秀校刊评选二等奖", org: "河北省高校评审委", level: "省级" },
